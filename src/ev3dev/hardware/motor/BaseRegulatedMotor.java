...
public abstract class BaseRegulatedMotor extends EV3DevDevice implements RegulatedMotor {
	...
	private final String RAMP_UP_SP = "ramp_up_sp";
	private final String RAMP_DOWN_SP = "ramp_down_sp";
	
    private int local_speed = 0;
    private int ramp_time_up = 0;
    private int ramp_time_down = 0;
    ...
    public int getRampUp() {
    	return getIntegerAttribute(RAMP_UP_SP);
    }
    public int getRampDown() {
    	return getIntegerAttribute(RAMP_DOWN_SP);
    }
    ...
    /**
     * Set the acceleration time of the motor.
     * @param time between launch and target speed
     */
    public void setRampUp(int time) {
    	this.ramp_time_up = time;
		String attribute = RAMP_UP_SP;
		this.setIntegerAttribute(attribute, this.ramp_time_up);
    }
    
    /**
     * Set the deceleration time of the motor.
     * @param time between launch and target speed
     */
    public void setRampDown(int time) {
    	this.ramp_time_down = time;
		String attribute = RAMP_DOWN_SP;
		this.setIntegerAttribute(attribute, this.ramp_time_down);
    }
